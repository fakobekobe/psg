 ...
 */
final class Version20260130193115 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Création de la table parametre';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE parametre (id INT AUTO_INCREMENT NOT NULL, domicile INT DEFAULT NULL, exterieur INT DEFAULT NULL, premiere_mt INT DEFAULT NULL, seconde_mt INT DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
