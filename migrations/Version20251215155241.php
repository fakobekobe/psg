 ...
 */
final class Version20251215155241 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Ajout du champ saison dans la table rencontre';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rencontre ADD saison_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_460C35EDF965414C ON rencontre (saison_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_460C35EDF965414C ON rencontre');
        $this->addSql('ALTER TABLE rencontre DROP saison_id');
