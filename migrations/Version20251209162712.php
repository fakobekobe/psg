 ...
 */
final class Version20251209162712 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Création de la table transfert';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE transfert (id INT AUTO_INCREMENT NOT NULL, equipe_saison_id INT NOT NULL, joueur_id INT NOT NULL, INDEX IDX_1E4EACBBA51424B7 (equipe_saison_id), INDEX IDX_1E4EACBBA9E2D76C (joueur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
