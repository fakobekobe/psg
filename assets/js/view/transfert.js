...
let P_URL = 'transfert', 
NOM_FORM = P_URL + "_", 
texteTitre = 'Ajouter un transfert';
const URL_SELECT = "equipe";
const PLACEHOLDER = "Equipe",
    LABEL_SELECT = ['saison', 'championnat', 'joueur'];
...
action_check(P_URL, NOM_FORM, "Modifier un transfert", check_select, LABEL_SELECT); // A modifier *******
...
initialiser_select("transfert_championnat", "transfert_equipe", URL_SELECT, PLACEHOLDER);
