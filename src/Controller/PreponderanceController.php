...
use App\Repository\PreponderanceRepository;
use Doctrine\ORM\EntityManagerInterface;
use Doctrine\Persistence\ManagerRegistry;
use App\Form\PreponderanceType;
use App\Traitement\Interface\ControlleurInterface;
use Symfony\Component\Security\Http\Attribute\IsGranted;

#[Route(path:'/preponderance')]
final class PreponderanceController extends AbstractController
{
    private const PREFIX_NAME = 'app_preponderance';
    private const PAGE = '_preponderance';
    private const TYPEFORM = PreponderanceType::class;
    private PreponderanceRepository $repository;
    ...
    {
        $this->repository = new PreponderanceRepository(registry: $this->registry);
    ...
    public function ajouter(Request $request): Response
    {
        ...
        if($contenu['reponse'] instanceof Response)
        {
            ...
            return $this->render(view: 'preponderance/index.html.twig', parameters: [
