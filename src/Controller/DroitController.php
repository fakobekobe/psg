...
final class DroitController extends AbstractController
{
    ...
    private const TYPEFORM = DroitType::class;
    private const PAGE = '_droit';
    ...
    {
        $this->repository = new DroitRepository(registry: $this->registry);
    ...
    public function ajouter(Request $request): Response
    {
        ...
        if($contenu['reponse'] instanceof Response)
        {
            ...
            return $this->render(view: 'droit/index.html.twig', parameters: [
