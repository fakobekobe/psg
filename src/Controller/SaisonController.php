...
{
    private const PREFIX_NAME = 'app_saison';
    private const PAGE = '_saison';
    private const TYPEFORM = SaisonType::class;
    ...
    {
        $this->repository = new SaisonRepository(registry: $this->registry);
    ...
    public function ajouter(Request $request): Response
    {
        ...
        if($contenu['reponse'] instanceof Response)
        {
            ...
            return $this->render(view: 'saison/index.html.twig', parameters: [
